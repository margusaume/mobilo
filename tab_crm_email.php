...
<section style="text-align:left; max-width:1024px">
  ...
  <?php
    ...
    if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST' && ($_GET['tab'] ?? '') === 'crm') {
        ...
        <tbody>
          <?php foreach ($rows as $em) { ?>
            <tr>
              ...
              <td>
                <form action="dashboard.php?tab=crm" method="post" style="display:flex; gap:6px; align-items:center">
